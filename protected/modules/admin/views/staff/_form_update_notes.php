...
<div class="row">
    <div class="col-lg-12">
        <label class="control-label" for="notes"><?php echo $form->label($model,Yii::t('admin/staff','notes')); ?></label>
    	<div class="controls">
...
<div class="row">
    <div class="col-lg-7">
        <label class="control-label" for="file_url"><?php echo $form->labelEx($model,'file_url'); ?></label>
                    ...
                    'config'=>array(
                       ...
                       'callbacks'=>array(
                          'onComplete'=>"js:function(id, name, response){ // for test purpose
                             $('#StaffNotes_file_url').val(response.filename);
                           }",
